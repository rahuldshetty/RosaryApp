...
public class MainFragment extends Fragment {
    ...
    ArrayList<Title> get_romi(){
        String names[] = {"Morning Prayers","Evening Prayers","Holy Rosary","Litany","Divine Mercy"};
    ...
    ArrayList<Title> get_konkani(){
        String names[] = {"¸ÀPÁ½Aa ¨sÉmÉÆ«","ªÀÄíeÁå zÉªÁ","«Ä¸ÉÛgï","¸Á¬ÄâtÂa ®¢£ï","zÉÊ«Pï PÁPÀÄ½ÛZÉÆ vÉÃ¸ïð"};
        ArrayList<Title> titles = new ArrayList<>();
        for(int i=0;i<5;i++){
            Title t = new Title();
            t.setId(i);
